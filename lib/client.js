...
function HistoryPanel(props) {
	const { sessionId, isSessionRunning, rebind, onRewound, onRewindFailed, onProgress, portalTo, onDialogOpen, onLanesChange, initialNotice, onInitialNoticeConsumed } = props;
	const [rows, setRows] = (0, react.useState)(void 0);
	const [head, setHead] = (0, react.useState)(null);
	const [busy, setBusy] = (0, react.useState)(false);
	const [selected, setSelected] = (0, react.useState)(null);
	const [rewindGuardNotice, setRewindGuardNotice] = (0, react.useState)(null);
	...
	*  timestamp are treated as ours, not the user's. */
	...
	return (0, react.createElement)(
		...
		rewindGuardNotice !== null ? (0, react_dom.createPortal)((0, react.createElement)("div", {
		...
		}, (0, react.createElement)("div", { className: DIALOG_HEAD }, (0, react.createElement)("h2", { className: DIALOG_TITLE }, "暂时无法回档"), (0, react.createElement)("button", {
			type: "button",
			className: DIALOG_CLOSE,
			title: "关闭",
			onClick: () => setRewindGuardNotice(null)
		}, "✕")), (0, react.createElement)("p", { className: DIALOG_DESCRIPTION }, rewindGuardNotice), (0, react.createElement)("div", { className: DIALOG_FOOT }, (0, react.createElement)("button", {
			type: "button",
			className: `${BUTTON} outline`,
			onClick: () => setRewindGuardNotice(null),
			style: { minWidth: 80 }
