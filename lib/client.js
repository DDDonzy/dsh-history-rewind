...
function FileChips(props) {
	...
	return (0, react.createElement)("div", { className: FILE_LIST }, (0, react.createElement)("div", { className: FILE_CLIP }, files.slice(0, MAX_FILES).map((file) => (0, react.createElement)("code", {
		className: FILE_CHIP,
		title: file,
		key: file
