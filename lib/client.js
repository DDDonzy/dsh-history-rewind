...
//#region node_modules/.pnpm/lucide-react@1.35.0_react@18.3.1/node_modules/lucide-react/dist/esm/shared/src/utils/mergeClasses.mjs
/**
...
//#endregion
//#region node_modules/.pnpm/lucide-react@1.35.0_react@18.3.1/node_modules/lucide-react/dist/esm/shared/src/utils/toKebabCase.mjs
/**
* @license lucide-react v1.35.0 - ISC
*
* This source code is licensed under the ISC license.
...
//#endregion
//#region node_modules/.pnpm/lucide-react@1.35.0_react@18.3.1/node_modules/lucide-react/dist/esm/shared/src/utils/toCamelCase.mjs
/**
* @license lucide-react v1.35.0 - ISC
*
* This source code is licensed under the ISC license.
...
//#endregion
//#region node_modules/.pnpm/lucide-react@1.35.0_react@18.3.1/node_modules/lucide-react/dist/esm/shared/src/utils/toPascalCase.mjs
...
//#endregion
//#region node_modules/.pnpm/lucide-react@1.35.0_react@18.3.1/node_modules/lucide-react/dist/esm/defaultAttributes.mjs
/**
* @license lucide-react v1.35.0 - ISC
*
* This source code is licensed under the ISC license.
...
//#endregion
//#region node_modules/.pnpm/lucide-react@1.35.0_react@18.3.1/node_modules/lucide-react/dist/esm/shared/src/utils/hasA11yProp.mjs
/**
* @license lucide-react v1.35.0 - ISC
*
* This source code is licensed under the ISC license.
...
//#endregion
//#region node_modules/.pnpm/lucide-react@1.35.0_react@18.3.1/node_modules/lucide-react/dist/esm/context.mjs
"use client";
const LucideContext = (0, react.createContext)({});
const useLucideContext = () => (0, react.useContext)(LucideContext);

//#endregion
//#region node_modules/.pnpm/lucide-react@1.35.0_react@18.3.1/node_modules/lucide-react/dist/esm/Icon.mjs
"use client";
...
//#endregion
//#region node_modules/.pnpm/lucide-react@1.35.0_react@18.3.1/node_modules/lucide-react/dist/esm/createLucideIcon.mjs
...
//#endregion
//#region node_modules/.pnpm/lucide-react@1.35.0_react@18.3.1/node_modules/lucide-react/dist/esm/icons/list-filter.mjs
const __iconNode$1 = [
	["path", {
		d: "M2 5h20",
		key: "1fs1ex"
...
//#endregion
//#region node_modules/.pnpm/lucide-react@1.35.0_react@18.3.1/node_modules/lucide-react/dist/esm/icons/x.mjs
...
async function refineSession(sessionId, turns) {
	const data = await post(`${ROUTE_PREFIX}/refine`, {
		sessionId,
		turns
	}, 12e4);
	if (data === null) return {
	...
	return {
		...
		...Array.isArray(data.maskedTurns) ? { maskedTurns: data.maskedTurns } : {},
		...Array.isArray(data.unmapped) ? { unmapped: data.unmapped } : {},
		...Array.isArray(data.remainingTurns) ? { remainingTurns: data.remainingTurns } : {},
		...
		...data.workspaceAttachmentFailure !== null && typeof data.workspaceAttachmentFailure === "object" ? { workspaceAttachmentFailure: data.workspaceAttachmentFailure } : {},
...
async function getRewindStatus(sessionId) {
	...
	return {
		...
		...typeof data.status === "string" || data.status === null ? { status: data.status } : {},
		...typeof data.reason === "string" ? { reason: data.reason } : {}
	};
}
...
async function getCacheSessionUsage(sessionId) {
...
//#endregion
//#region src/client/history-command.ts
/** Session-scoped one-shot gate for persisted /history command rows. */
const openedHistoryCommandKeys = new Set();
/**
...
*/
function claimHistoryCommand(sessionId, commandId) {
	if (commandId === void 0 || commandId.length === 0) return false;
...
*/
async function refreshRewoundSession(session) {
...
function layoutGraph(rows, headSha = null) {
	const topoOrder = rows.slice().reverse();
	...
	const rootOf = (start) => {
		...
		for (;;) {
			...
			const parent = parentSha === void 0 ? void 0 : bySha.get(parentSha);
			if (parent === void 0) {
				rootSha = current.sha;
				break;
			}
	...
	for (const row of topoOrder) {
		...
		if (component === void 0) componentRows.set(rootSha, [row]);
		else component.push(row);
	}
	const roots = Array.from(componentRows.keys()).map((sha) => bySha.get(sha)).sort((a, b) => {
	...
	for (const row of order) {
		...
		if (parent === void 0 || !bySha.has(parent)) continue;
		const children = childrenOf.get(parent);
		if (children === void 0) childrenOf.set(parent, [row]);
	...
	const localLane = new Map();
	const componentWidth = new Map();
...
const STYLES = [
	...
	"}",
	".dsh-history-row.is-masked .dsh-history-row-content {",
	"  opacity: 0.48;",
	"  filter: grayscale(0.9) brightness(0.88);",
	"  border-color: rgba(255, 255, 255, 0.07);",
	"}",
	".dsh-history-row.is-masked:hover .dsh-history-row-content {",
	"  opacity: 0.58;",
	"  border-color: rgba(194, 133, 73, 0.32);",
	"  box-shadow: 0 4px 16px rgba(0, 0, 0, 0.42);",
	"}",
	"/* Current-road-only Context Curation selection. */",
	".dsh-history-row.is-curation-selecting .dsh-history-row-content {",
	"  opacity: 1;",
	"  filter: none;",
	"  border-color: rgba(77, 136, 255, 0.8) !important;",
	"  box-shadow: 0 0 0 1px rgba(77, 136, 255, 0.22), 0 4px 16px rgba(0, 0, 0, 0.35);",
	"}",
	".dsh-history-row.is-curation-selecting:hover .dsh-history-row-content {",
	"  border-color: rgba(100, 154, 255, 0.95) !important;",
	"  box-shadow: 0 0 0 1px rgba(77, 136, 255, 0.34), 0 6px 20px rgba(0, 0, 0, 0.46);",
	"}",
	".dsh-history-row.is-curation-selecting.is-masked .dsh-history-row-content,",
	".dsh-history-row.is-curation-selecting.is-masked:hover .dsh-history-row-content {",
	"  opacity: 0.48;",
	"  filter: grayscale(0.92) brightness(0.86);",
	"  background: rgba(43, 43, 46, 0.94) !important;",
	"  border-color: rgba(151, 151, 156, 0.25) !important;",
	"  box-shadow: 0 3px 12px rgba(0, 0, 0, 0.3);",
	"}",
	".dsh-history-selection-close {",
	"  position: absolute;",
	"  top: 4px;",
	"  right: 10px;",
	"  z-index: 5;",
	...
	"  height: 30px;",
	"  padding: 0;",
	"  border: 1px solid rgba(112, 158, 244, 0.44);",
	"  border-radius: 50%;",
	"  color: #8eb6ff;",
	"  background: rgba(33, 43, 63, 0.94);",
	...
	"}",
	".dsh-history-selection-close:hover,",
	".dsh-history-selection-close:focus-visible {",
	"  color: #ffffff;",
	"  border-color: rgba(141, 180, 255, 0.8);",
	"  background: rgba(56, 79, 122, 0.98);",
	"  transform: scale(1.06);",
	"  outline: none;",
	"}",
	".dsh-badge-curation {",
	"  color: #ffd0a1;",
	"  background: rgba(230, 116, 32, 0.26);",
	"  border: 1px solid rgba(247, 147, 71, 0.38);",
	"}",
	".dsh-history-curation-turn-chip {",
	"  flex: none;",
	"  display: inline-flex;",
	"  align-items: center;",
	"  padding: 0 7px;",
	"  border-radius: 3px;",
	"  border: 1px solid rgba(190, 130, 69, 0.24);",
	"  color: #d8b38a;",
	"  background: rgba(111, 94, 78, 0.72);",
	"  font: 600 10px/15px var(--ds-font-family-code, monospace);",
	"  white-space: nowrap;",
	"}",
	".dsh-history-curation-turn-chip.is-more {",
	"  color: #c29d75;",
	"  background: rgba(103, 90, 78, 0.56);",
	"}",
	...
	".dsh-history-file-clip .dsh-history-curation-turn-chip {",
	"  flex: 0 1 auto;",
	"  min-width: 0;",
	"  overflow: hidden;",
	"  text-overflow: ellipsis;",
	...
	"}",
	".dsh-history-action-dock.is-curation {",
	"  flex: none;",
	"  justify-content: flex-end;",
	"  background: transparent;",
	"  border-top: 0;",
...
const CURATION_TURN_CHIP = "dsh-history-curation-turn-chip";
const SELECTION_CLOSE = "dsh-history-selection-close";
const BUTTON = "dsh-history-button";
const ACTION_DOCK = "dsh-history-action-dock";
...
async function openPublishedSession(sessions, sessionId) {
	if (sessions.refresh !== void 0) await sessions.refresh();
	if (sessions.open === void 0) throw new Error("Client Session service exposes no open() operation");
...
function fileChangeText(change) {
	const symbol = change.status === "A" ? "+" : change.status === "D" ? "-" : "·";
	const name = change.path.split(/[/\\]/).pop() ?? change.path;
	return `${symbol} ${name}`;
}
function fileChangeTitle(change) {
	const symbol = change.status === "A" ? "+" : change.status === "D" ? "-" : "·";
...
function fitLabelChips(labels, budget) {
	...
	if (count === 0) count = 1;
	return {
		shown: labels.slice(0, count),
		hidden: labels.length - count
	};
}
...
function FileChips(props) {
	...
	}, fileChangeText(file))), hidden > 0 ? (0, react.createElement)("code", {
...
function RowContentNode(props) {
	...
	if (kind === "refine") {
		...
		return (0, react.createElement)("div", { className: ROW_CONTENT }, (0, react.createElement)("div", { className: ROW_MAIN }, (0, react.createElement)("div", { className: `${SINGLE_LINE} ${FILE_LIST}` }, (0, react.createElement)("span", { className: "dsh-badge dsh-badge-curation" }, "CONTEXT CURATION"), labels.length > 0 ? (0, react.createElement)("div", { className: FILE_CLIP }, shown.map((label) => (0, react.createElement)("code", {
			className: CURATION_TURN_CHIP,
			title: `${label} hidden from the curated context`,
			key: label
		}, label)), hidden > 0 ? (0, react.createElement)("code", {
			className: `${CURATION_TURN_CHIP} is-more`,
			title: labels.slice(shown.length).join("\n")
		}, `…${hidden}`) : null) : null)), sideElements);
	}
...
function GraphOverlay(props) {
	const { index, visibleRows, lanes, colors, headRoad, headSha, hoverSha, futureSet, hoverPath, geom, height } = props;
	...
	*/
	...
	const pushEdge = (childSha, childLane, parentSha) => {
		...
		const stroke = onPathEdge ? HOVER : hovering ? grey : futureSet.has(childSha) ? AFTER_HEAD : onHeadEdge ? colors[childLane % colors.length] : grey;
		const opacity = onPathEdge ? 1 : hovering ? .45 : onHeadEdge ? .85 : .6;
		let d;
		if (parentY === null) d = `M ${x0} ${startY} L ${x0} 0`;
		else if (x0 === x1) d = `M ${x0} ${startY} L ${x1} ${endY}`;
		else {
			const p1x = x1;
			const p1y = endY;
			const p2x = x0;
	...
	for (const row of visibleRows) {
		...
		const nodeColor = onPath ? HOVER : hovering ? grey : isHead ? colors[row.lane % colors.length] : futureSet.has(row.sha) ? AFTER_HEAD : row.isHeadRoad ? colors[row.lane % colors.length] : grey;
...
function HistoryRow(props) {
	const { row, lanes, isHead, isSelected, onHover, onSelect, anchor, chipBudget, curationSelectable, selectionMode, hidden, onVisibilityToggle } = props;
...
function HistoryPanel(props) {
	const { sessionId, isSessionRunning, rebind, openDerivedSession, onDerivedCreated, onRewound, onRewindFailed, onProgress, portalTo, onDialogOpen, onSelectionModeChange, onLanesChange, initialNotice, onInitialNoticeConsumed } = props;
	...
	const [maskedTurns, setMaskedTurns] = (0, react.useState)(new Set());
	...
	const [refineOpen, setRefineOpen] = (0, react.useState)(false);
	/** Running-session guard dialog: title + text (rewind vs refine wording). */
	const [guardNotice, setGuardNotice] = (0, react.useState)(null);
	const selectionGuardRun = (0, react.useRef)(0);
	const [notice, setNotice] = (0, react.useState)(initialNotice ?? "");
	const [errorLog, setErrorLog] = (0, react.useState)(null);
	(0, react.useEffect)(() => {
	...
	(0, react.useEffect)(() => () => onSelectionModeChange(false), [onSelectionModeChange]);
	(0, react.useEffect)(() => {
	...
	*  immediately (the graph stays on HEAD unless the user wants to switch). */
	...
	const timelineLoadRun = (0, react.useRef)(0);
	const load = async () => {
		...
		if (result.ok && result.rows !== void 0) {
			...
			setRows(null);
			setErrorLog(typeof result.reason === "string" ? `[timeline-error]: failed to fetch timeline (${result.reason})\n  at GET /dsh-history-rewind/api/timeline?sessionId=${sessionId}` : `[timeline-error]: network transport error or host service unavailable`);
		}
	};
	(0, react.useEffect)(() => {
		load();
		return () => {
			timelineLoadRun.current += 1;
		};
	}, [sessionId]);
	(0, react.useEffect)(() => () => {
	...
	const selectRewindTarget = async (target) => {
		const projectedRunning = isSessionRunning();
		if (projectedRunning === true) {
			setSelected(null);
			setGuardNotice({
				title: "暂时无法回档",
				text: "当前会话正在执行任务。请等待任务结束，或先终止任务后再次尝试。"
			});
			return;
		}
	...
	const openRefine = () => {
		...
		if (projectedRunning === true) {
			setGuardNotice({
				title: "CONTEXT CURATION UNAVAILABLE",
				text: "当前会话正在执行任务。请等待任务结束，或先终止任务后再次尝试。"
			});
			return;
		}
	...
	const doRefine = async () => {
		...
		if (!result.ok) {
			...
			const unmapped = result.unmapped !== void 0 && result.unmapped.length > 0 ? `（以下 TURN 未找到：${result.unmapped.join(", ")}）` : "";
			setNotice(`Context Curation 失败：${reason}${result.error !== void 0 ? `（${result.error}）` : ""}${unmapped}`);
			return;
		}
		if (result.newSessionId === void 0) {
			setBusy(false);
		...
		try {
			...
			setBusy(false);
			setNotice(`新会话已创建（${result.newSessionId}），但客户端无法自动打开：${error instanceof Error ? error.message : String(error)}`);
			return;
		}
		setMaskedTurns(new Set());
		setBusy(false);
		onDerivedCreated();
		if (result.warning !== void 0) console.warn(`[dsh-history-rewind] Context Curation created ${result.newSessionId}; hidden ${masked} TURN(s): ${result.warning}`);
	};
	const graphRows = (0, react.useMemo)(() => {
		if (rows === void 0 || rows === null || !selectionMode || head === null) return rows;
	...
	const graph = (0, react.useMemo)(() => graphRows === void 0 || graphRows === null ? null : buildGraph(graphRows, head), [graphRows, head]);
	const headSha = head;
	(0, react.useEffect)(() => {
		if (graph !== null) onLanesChange?.(graph.lanes);
	}, [graph, onLanesChange]);
	...
	*  changes, so hover/scroll re-renders never re-walk the commit list. */
	...
	const headRoadSet = (0, react.useMemo)(() => {
		const set = new Set();
	...
	*  timestamp are treated as ours, not the user's. */
	...
	const hoverPath = (0, react.useMemo)(() => {
		if (hoverSha === null || graphRows === void 0 || graphRows === null) return null;
	...
	if (rows.length === 0) return (0, react.createElement)("div", {
		...
		fontWeight: 600,
		color: "var(--dsw-alias-label-primary, #f5f5f7)"
	} }, "暂无快照记录"), (0, react.createElement)("p", { style: {
		margin: "0 0 24px 0",
		fontSize: 13,
		lineHeight: "1.6",
		color: "var(--dsw-alias-label-secondary, #9ca3af)",
		maxWidth: 320
	} }, "当前会话尚未产生消息快照。发送消息后，TURN 开始与结束将自动记录，或点击下方按钮手动创建。"), (0, react.createElement)("button", {
		type: "button",
		className: `${BUTTON} outline`,
		disabled: busy,
		style: {
	...
	}, busy ? (0, react.createElement)("span", { style: {
		width: 14,
		height: 14,
	...
	return (0, react.createElement)(
		"div",
		{ className: `${PANEL}${selectionMode ? " is-curation-selection" : ""}` },
		selectionMode ? (0, react.createElement)("button", {
			type: "button",
		...
		(0, react.createElement)(
			...
			(0, react.createElement)("div", {
				...
				onHover,
				onSelect: (target) => {
					selectRewindTarget(target);
				},
				anchor: row.sha === headSha,
				curationSelectable: (row.meta?.kind === "turn-end" || row.meta?.kind === "turn-start") && typeof row.meta?.turn === "number",
				selectionMode,
				hidden: row.meta?.turn !== void 0 && maskedTurns.has(row.meta.turn),
		...
		(0, react.createElement)("div", { className: `${ACTION_DOCK} is-curation` }, (0, react.createElement)("button", {
			type: "button",
			className: `${BUTTON} outline`,
			disabled: busy || selectionMode && maskedTurns.size === 0,
			title: selectionMode ? `Create an independent Session without ${maskedTurns.size} hidden TURN${maskedTurns.size === 1 ? "" : "s"}` : "Choose TURNs for a curated Session",
			onClick: (event) => {
				event.stopPropagation();
				if (selectionMode) openRefine();
				else enterSelectionMode();
			}
		}, (0, react.createElement)(ListFilter, {
			size: 15,
			strokeWidth: 1.8,
			"aria-hidden": true
		...
		guardNotice !== null ? (0, react_dom.createPortal)((0, react.createElement)("div", {
		...
		}, (0, react.createElement)("div", { className: DIALOG_HEAD }, (0, react.createElement)("h2", { className: DIALOG_TITLE }, guardNotice.title), (0, react.createElement)("button", {
			type: "button",
			className: DIALOG_CLOSE,
			title: "关闭",
			onClick: () => setGuardNotice(null)
		}, "✕")), (0, react.createElement)("p", { className: DIALOG_DESCRIPTION }, guardNotice.text), (0, react.createElement)("div", { className: DIALOG_FOOT }, (0, react.createElement)("button", {
			type: "button",
			className: `${BUTTON} outline`,
			onClick: () => setGuardNotice(null),
			style: { minWidth: 80 }
		...
		refineOpen ? (0, react_dom.createPortal)((0, react.createElement)("div", {
			className: MODAL_BACKDROP,
			style: {
				position: "fixed",
				inset: 0,
			...
			onClick: (event) => event.stopPropagation()
		}, (0, react.createElement)("div", { className: DIALOG_HEAD }, (0, react.createElement)("h2", { className: DIALOG_TITLE }, "CONTEXT CURATION"), (0, react.createElement)("button", {
			className: DIALOG_CLOSE,
			title: "关闭",
			onClick: () => setRefineOpen(false)
		}, "✕")), (0, react.createElement)("p", { className: DIALOG_DESCRIPTION }, "将创建一个独立的新会话，并从其模型上下文中隐藏 ", (0, react.createElement)("strong", null, `${maskedTurns.size} 个 TURN`), "。当前会话及其历史记录不会被修改。"), (0, react.createElement)("div", { className: DIALOG_FOOT }, (0, react.createElement)("button", {
			className: `${BUTTON} outline`,
			disabled: busy,
			onClick: () => setRefineOpen(false)
...
function CacheCard() {
	...
	const [collapsedWorkspaces, setCollapsedWorkspaces] = (0, react.useState)(new Set());
	...
	const sessionUsageRun = (0, react.useRef)(0);
	const load = async () => {
	...
	const openClearFlow = async () => {
		...
		Promise.all(sessions.map(async (summary) => {
	...
	const sessionGroups = (0, react.useMemo)(() => {
		...
		})).sort((a, b) => a.workspace.localeCompare(b.workspace, void 0, {
			numeric: true,
			sensitivity: "base"
		}));
	}, [sessionsList]);
	...
	const setWorkspaceSelected = (sessions, selected) => {
		setSelectedSessionIds((current) => {
			const next = new Set(current);
			for (const session of sessions) if (selected) next.add(session.sessionId);
	...
	const renderSessionRow = (s) => {
		...
		return (0, react.createElement)("label", {
			...
			title: s.title ?? "未命名会话"
		}, s.title ?? "未命名会话"), (0, react.createElement)("span", { style: {
			fontSize: 11,
			fontFamily: "var(--ds-font-family-code, monospace)",
			color: "var(--dsw-alias-label-secondary, #aaa)",
			flex: "none"
		} }, s.usageLoaded !== true ? "统计中…" : s.usageError === true ? "读取失败" : formatBytes(s.totalBytes))), (0, react.createElement)("div", { style: {
			display: "flex",
			alignItems: "center",
			gap: 6,
			minWidth: 0,
			...
			title: s.sessionId
		}, s.sessionId), (0, react.createElement)("span", { style: {
			flex: "none",
			opacity: .65
		} }, "|"), (0, react.createElement)("code", {
			style: {
			...
			title: s.commit
		}, s.commit?.slice(0, 7) ?? "-------"), (0, react.createElement)("span", {
			style: {
				flex: "none",
				marginLeft: "auto",
				whiteSpace: "nowrap"
		...
		}, s.lastModified > 0 ? new Date(s.lastModified).toLocaleString([], {
			month: "2-digit",
			day: "2-digit",
			hour: "2-digit",
			minute: "2-digit"
	...
	return (0, react.createElement)(
		...
		dialogStep !== "closed" ? (0, react.createElement)("div", {
			...
			(0, react.createElement)("div", { style: {
				...
				color: "#999",
				fontSize: 12
			} }, "当前没有存储任何会话快照") : sessionGroups.map((group) => {
				const collapsed = collapsedWorkspaces.has(group.workspace);
				const selectedCount = group.sessions.reduce((count, session) => count + (selectedSessionIds.has(session.sessionId) ? 1 : 0), 0);
				...
				return (0, react.createElement)("div", {
					...
					color: "var(--dsw-alias-label-secondary, #aaa)"
				} }, collapsed ? "+" : "−"), (0, react.createElement)("span", { style: {
					minWidth: 0,
					overflow: "hidden",
					textOverflow: "ellipsis",
					whiteSpace: "nowrap",
					fontSize: 12,
					fontWeight: 600
				} }, group.workspace), (0, react.createElement)("span", { style: {
					marginLeft: "auto",
					paddingLeft: 8,
					flex: "none",
					fontSize: 10,
					color: "var(--dsw-alias-label-tertiary, #777)"
				} }, String(group.sessions.length)))), collapsed ? null : (0, react.createElement)("div", { style: {
					display: "flex",
					flexDirection: "column",
					gap: 2,
					marginLeft: 16,
...
function apply(ctx) {
	...
	*  (it closes immediately on confirm); delivered to the next panel mount. */
	...
	const HistoryPanelShell = () => {
		...
		const [selectionModeOpen, setSelectionModeOpen] = (0, react.useState)(false);
		...
		const cardTransform = cardOpticalOffset >= 0 ? `translateX(calc(-50% - ${cardOpticalOffset}px))` : `translateX(calc(-50% + ${Math.abs(cardOpticalOffset)}px))`;
		(0, react.useLayoutEffect)(() => {
			if (!open) return;
		...
		const panel = open && sessionId !== void 0 ? (0, react.createElement)(
			...
			(0, react.createElement)("div", {
			...
			}, !selectionModeOpen ? (0, react.createElement)("button", {
				type: "button",
				className: SELECTION_CLOSE,
				title: "关闭 History",
				...
				strokeWidth: 1.9,
				"aria-hidden": true
			})) : null, (0, react.createElement)(HistoryPanel, {
				sessionId,
	...
	function HistoryCommandRow(props) {
		const commandId = typeof props.node?.commandId === "string" ? props.node.commandId : void 0;
		const commandKey = commandId === void 0 ? void 0 : `${props.sessionId ?? ""}:${commandId}`;
		...
		const done = props.node?.outcome !== null && props.node?.outcome !== void 0;
		return (0, react.createElement)("div", { style: {
			display: "flex",
			alignItems: "center",
			gap: 8,
